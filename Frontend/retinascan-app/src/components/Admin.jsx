    ...
    return (
      <div style={{ marginBottom: 20 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
          ...
          <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 14, fontWeight: 700, color: '#0369a1' }}>{value}{unit}</span>
        </div>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 40px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 36 }}>
          <div>
            ...
            <h1 style={{ margin: 0, fontFamily: 'Manrope, sans-serif', fontSize: 28, fontWeight: 800, letterSpacing: '-0.02em', color: '#0f172a' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '340px 1fr', gap: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            <div style={{
              ...
              background: '#ffffff', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05), 0 2px 4px -2px rgba(0,0,0,0.05)',
            }}>
              <h3 style={{ margin: '0 0 20px', fontSize: 14, fontWeight: 700, color: '#0f172a' }}>Capacity Parameters</h3>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 10, fontWeight: 600, color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 8, fontFamily: 'JetBrains Mono, monospace' }}>AI Recommendation</div>
              ...
              <div style={{ fontSize: 12, color: '#334155', lineHeight: 1.6 }}>
                Recommended: <strong style={{ color: '#0369a1' }}>{recommendedOphthos} ophthalmologists</strong> to clear backlog within target SLA.
                {backlogPerDay > 0 && ` Backlog exhausts capacity in ~${daysToExhaust} days.`}
              </div>
            </div>

            {/* Severity distribution */}
            <div style={{ padding: 20, borderRadius: 14, background: '#ffffff', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05), 0 2px 4px -2px rgba(0,0,0,0.05)' }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: '#0f172a', marginBottom: 14 }}>Case Severity Distribution</div>
              {sevDist.map(s => (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 12 }}>
              {[
                { label: 'Total Cameras',       value: cameras,          unit: '',      color: '#0369a1' },
                { label: 'Daily Capacity',       value: cameras * dailyScans, unit: ' scans', color: '#0284c7' },
                ...
                <div key={k.label} style={{ padding: '16px 20px', borderRadius: 14, background: '#ffffff', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05), 0 2px 4px -2px rgba(0,0,0,0.05)' }}>
                  <div style={{ fontSize: 10, color: '#64748b', marginBottom: 8, fontFamily: 'JetBrains Mono, monospace' }}>{k.label}</div>
            ...
            {/* SVG Bar Chart */}
            <div style={{ padding: 24, borderRadius: 16, background: '#ffffff', border: '1px solid #e2e8f0', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.05), 0 2px 4px -2px rgba(0,0,0,0.05)', flex: 1 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
                <h3 style={{ margin: 0, fontSize: 14, fontWeight: 700, color: '#0f172a' }}>Weekly Throughput</h3>
                <div style={{ display: 'flex', gap: 16, fontSize: 11, color: '#64748b' }}>
                  <span style={{ display: 'flex', alignItems: 'center', gap: 5 }}><span style={{ width: 10, height: 10, borderRadius: 2, background: '#0369a1', display: 'inline-block' }} /> Scans</span>
                  <span style={{ display: 'flex', alignItems: 'center', gap: 5 }}><span style={{ width: 10, height: 10, borderRadius: 2, background: 'rgba(2,132,199,0.6)', display: 'inline-block' }} /> Reviewed</span>
                </div>
              </div>
              ...
              <svg width="100%" height="200" viewBox={`0 0 ${chartData.length * 100} 200`} preserveAspectRatio="none">
                {chartData.map((d, i) => {
                  ...
                  return (
                    <g key={i}>
                      <rect x={x} y={195 - barH} width={30} height={barH} fill="#0369a1" fillOpacity="0.7" rx="4"/>
                      <rect x={x + 35} y={195 - revH} width={30} height={revH} fill="#0284c7" fillOpacity="0.35" rx="4"/>
                      <text x={x + 30} y="210" textAnchor="middle" fill="#64748b" fontSize="11" fontFamily="JetBrains Mono, monospace">{d.day}</text>
                    </g>
                  );
                })}
